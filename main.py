...
obj_1 = objects.Obj(table=my_table,width=100,height=15,x_posn=65,y_posn=175,color="red")
obj_2 = objects.Obj(table=my_table,width=100,height=15,x_posn=100,y_posn=195,color="red")
...
#5window.bind("<Right>", ball.move_right)
